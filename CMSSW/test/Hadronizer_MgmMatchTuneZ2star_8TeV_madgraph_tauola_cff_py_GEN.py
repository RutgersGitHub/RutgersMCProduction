...
# with command line options: Configuration/GenProduction/python/EightTeV/Hadronizer_MgmMatchTuneZ2star_8TeV_madgraph_tauola_cff.py --step GEN --beamspot Realistic8TeVCollision --conditions START50_V13::All --pileup NoPileUp --datamix NODATAMIXER --eventcontent RAWSIM --datatier GEN-SIM --filein=file:8TeV_TTW_run1_unweighted_events_qcut20_mgPostv2.lhe --no_exec
...
process.generator = cms.EDFilter("Pythia6HadronizerFilter",
    ...
    jetMatching = cms.untracked.PSet(
        ...
        MEMAIN_qcut = cms.double(options.qCut),
