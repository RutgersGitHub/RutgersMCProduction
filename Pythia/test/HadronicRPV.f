...
C...HadronicRPV production at CMS LHC.
...
C...Select HadronicRPV production processes.
      ...
      IMSS(53) = 3              ! RPV UDD on with user specified couplings
      IF (trim(coupling) .EQ. 'UDD112') THEN
        RVLAMB(1,1,2) = 0.005   ! UDD coupling
      END IF
      RMSS( 1) = 300.0          ! bino
      RMSS( 2) = 3000.0         ! wino
