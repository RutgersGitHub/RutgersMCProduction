...
C...WW pair production at CMS LHC.
...
C...Select WW pair production processes.
      MSEL = 0          ! user defined process
      MSUB(25) = 1      ! W+W- pair production
      MDME(190,1) = 0   ! W+ --> dbar     u
      MDME(191,1) = 0   ! W+ --> dbar     c
      MDME(192,1) = 0   ! W+ --> dbar     t
      MDME(193,1) = 0   ! W+ --> dbar     t'
      MDME(194,1) = 0   ! W+ --> sbar     u
      MDME(195,1) = 0   ! W+ --> sbar     c
      MDME(196,1) = 0   ! W+ --> sbar     t
      MDME(197,1) = 0   ! W+ --> sbar     t'
      MDME(198,1) = 0   ! W+ --> bbar     u
      MDME(199,1) = 0   ! W+ --> bbar     c
      MDME(200,1) = 0   ! W+ --> bbar     t
      MDME(201,1) = 0   ! W+ --> bbar     t
      MDME(202,1) = 0   ! W+ --> b'bar    u
      MDME(203,1) = 0   ! W+ --> b'bar    c
      MDME(204,1) = 0   ! W+ --> b'bar    t
      MDME(205,1) = 0   ! W+ --> b'bar    t'
      MDME(206,1) = 1   ! W+ --> e+       nu_e
      MDME(207,1) = 1   ! W+ --> mu+      nu_mu
      MDME(208,1) = 1   ! W+ --> tau+     nu_tau
      MDME(209,1) = 0   ! W+ --> tau'+    nu'_tau
